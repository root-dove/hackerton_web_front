...
export default function Header() {
    ...
    return (
        <div className="h-full rounded-tr bg-gray-900">
            ...
            <div id="Main" className={`${show ? 'translate-x-0' : '-translate-x-full'} transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 bg-gray-900 flex-col`}>
